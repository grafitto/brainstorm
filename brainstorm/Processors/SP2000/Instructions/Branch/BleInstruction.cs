...
{
    class BleInstruction : ThreeOperandInstruction
    {
        private string firstRegister;
        private string secondRegister;
        private int address;
        public BleInstruction(string instruction, string firstRegister, string secondRegister, int address) : base(instruction, firstRegister, secondRegister, address.ToString())
        {
