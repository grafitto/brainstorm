...
namespace brainstorm.Processors.SP2000.Instructions.Branch
{
    class BltInstruction : ThreeOperandInstruction
    {
        ...
        private int address;
        public BltInstruction(string instruction, string firstRegister, string secondRegister, int address) : base(instruction, firstRegister, secondRegister, address.ToString())
        {
