...
namespace BrainStorm.Processors.SP2000.Instructions.Bitwise
{
    ...
    {
        public OrInstruction(string instruction, string destination, string firstOperand, string secondOperand) : base(instruction, destination, firstOperand, secondOperand)
        {
        }
